...
if __name__ == '__main__':
    ...
    LABEL = Label(TOP, bg="red", text="Welcome to BMI Calculator", font=("Helvetica", 15, "bold"), pady=10)
    LABEL.place(x=55, y=0)
    LABEL1 = Label(TOP, bg="red", text="Enter Weight (in kg):", bd=6,
                   font=("Helvetica", 10, "bold"), pady=5)
    LABEL1.place(x=55, y=60)
    ENTRY1 = Entry(TOP, bd=8, width=6, font="Roboto 11")
    ENTRY1.place(x=240, y=60)
    LABEL2 = Label(TOP, bg="red", text="Enter Height (in cm):", bd=6,
                   font=("Helvetica", 10, "bold"), pady=5)
    LABEL2.place(x=55, y=121)
    ENTRY2 = Entry(TOP, bd=8, width=6, font="Roboto 11")
    ENTRY2.place(x=240, y=121)
    BUTTON = Button(bg="red", bd=12, text="BMI", padx=33, pady=15, command=calculate_bmi,
